...
namespace LuyenThiTracNghiem. Components
{
    ...
    public class TrendingExamWeeklyComponent : ViewComponent
    {
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            var listTrendingExamWeekly = (from exam in _context.Exams
                                    join attempt in _context.ExamAttempts 
                                        on exam.ExamId equals attempt.ExamId
                                    where exam.Status == true 
                                          && attempt.IsCompleted == true
                                          && attempt.StartedAt >= weekAgo
            ...
            return await Task.FromResult((IViewComponentResult)View("Default", listTrendingExamWeekly));
        }
    }
}